    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <!-- <li class="sidebar-menu-item {{menuActive('admin.generatepin*',1)}}">
                    <a href="{{ route('admin.generatepin.index')}}" class="nav-link ">
                        <i class="menu-icon fa fa-map-pin"></i>
                        <span class="menu-title">@lang('Generate Pin')</span>
                    </a>
                </li> -->
				
                 <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.category*',3).' '.menuActive('admin.product*',3)}}">
                        <i class="menu-icon las la-paper-plane"></i>
                        <span class="menu-title">@lang('Manage Helps')</span>
                       
                    </a>
                 <div class="sidebar-submenu {{menuActive('admin.category*',2).' '.menuActive('admin.product*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.provide_help')}} ">
                                <a href="{{route('admin.provide_help')}}" class="nav-link">
                                    <i class="menu-icon fa-list-alt"></i>
                                    <span class="menu-title">@lang('Provide Help')</span>
                                </a>
                            </li>

                          <li class="sidebar-menu-item {{menuActive('admin.product*','admin.product.index')}} ">
                                <a href="{{route('admin.get_help')}}" class="nav-link">
                                    <i class="menu-icon las la-lock"></i>
                                    <span class="menu-title">@lang('Get Help')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                 ...
                 <div class="sidebar-submenu {{menuActive('admin.order*',2)}} ">
                             <ul>
                              <li class="sidebar-menu-item {{menuActive(['admin.order.*', 'admin.order.index'])}} ">
                ...
                <!-- <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.plan*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.plan.index', 'admin.plan.edit', 'admin.plan.subscribers'])}} ">
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.plan.subscribers.index', 'admin.plan.subscribers.search'])}} ">
                                <a href="{{route('admin.plan.subscribers.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All subscribers')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <!-- <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.pin*',3)}}">
                        ...
                        <span class="menu-title">@lang('Created Pin')</span>
                    </a>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.pin.user')}} ">
                                <a href="{{route('admin.pin.user')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Users Pin')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.pin.generate')}} ">
                                <a href="{{route('admin.pin.generate')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Admin Pin')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.pin.used')}} ">
                                <a href="{{route('admin.pin.used')}}" class="nav-link">
                                    ...
                                    <span class="menu-title">@lang('Used Pin')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.pin.unused')}} ">
                                <a href="{{route('admin.pin.unused')}}" class="nav-link">
                                    <i class="menu-icon las la-lock"></i>
                                    <span class="menu-title">@lang('Unused Pin')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
...
<!-- 
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.report*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.report.provide_helps','admin.report.commissions.search', 'admin.report.commissions.log'])}}">
                                <a href="{{route('admin.report.provide_helps')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Provide Helps')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive(['admin.report.get_helps','admin.report.commissions.search', 'admin.report.commissions.log'])}}">
                                <a href="{{route('admin.report.get_helps')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Get Helps')</span>
                                </a>
                            </li>

                          <!--  <li class="sidebar-menu-item {{menuActive(['admin.report.recharge','admin.report.recharge.search'])}}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.report*',3)}}">
                        <i class="menu-icon la la-list"></i>
                        <span class="menu-title">@lang('Web Tasks') </span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.report*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.web_tasks.upload','admin.report.commissions.search', 'admin.report.commissions.log'])}}">
                                <a href="{{route('admin.web_tasks.upload')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Add new url')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive(['admin.userWebTaskSubmission','admin.report.commissions.search', 'admin.report.commissions.log'])}}">
                                <a href="{{route('admin.userWebTaskSubmission')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('User Submissions')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.frontend.sections*',2)}} ">
                        <ul>
                            ...
                            @foreach(getPageSections(true) as $k => $secs)
							   @if($secs['builder'] && ($secs['name']=='Social Icons' || $secs['name']=='About Us'))
                            ...
                            <!-- <li class="sidebar-menu-item {{menuActive(['admin.sms.template.index','admin.sms.template.edit'])}} ">
                                <a href="{{ route('admin.frontend.plan_detail') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Plan Detail')</span>
                                </a>
                            </li> -->
                        </ul>
                    </div>
