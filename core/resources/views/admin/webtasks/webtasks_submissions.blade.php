    ...
    <div class="row">
        ...
        <thead>
            <tr>
                ...
                <th>@lang('Submitted Url')</th>
                <th>@lang('Task Url')</th>
                <th>@lang('Submitted Date/Time')</th>
                <th>@lang('Action')</th>
            </tr>
        </thead>
        <tbody>
        ...
        @forelse($webTasks as $data)
            <tr>
                ...
                <td data-label="@lang('Name')">
                    {{__ ($data->user->firstname)}}<br>
                    <span>{{__ ($data->user->email)}}</span>
                </td>
                <td data-label="@lang('Name')">
                    {{__ ($data->submitted_url)}}
                </td>
                <td data-label="@lang('Name')">
                    {{__ ($data->tasks->task_url)}}
                </td>
