    ...
    <div class="row mb-none-30">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--cyan b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['provide_helps']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Provide Helps')</span>
                    </div>
                    <a href="{{route('admin.provide_help')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--orange b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['get_helps']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Get Helps')</span>
                    </div>

                    <a href="{{route('admin.get_help')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['support']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Support Enquires')</span>
                    </div>

                    <a href="{{route('admin.ticket')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
  ...
  <!-- <div class="row mt-50 mb-none-30">
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$matirxInfo['plan']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Plan')</span>
                    </div>
                    <a href="{{route('admin.plan.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div> -->
        ...
        <!-- <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$matirxInfo['subscription']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Subscribers Plan')</span>
                    </div>
                    <a href="{{route('admin.plan.subscribers.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div> -->
         ...
         <!-- <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--6 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{getAmount($commissions)}} {{$general->cur_text}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Commissions')</span>
                    </div>

                    <a href="{{route('admin.report.commissions')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div> -->
     </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--12 b-radius--10 box-shadow d-none" >
                <div class="icon">
                    <i class="las la-key"></i>
                </div>
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$pin}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Pin')</span>
                    </div>

                    <a href="{{route('admin.pin.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
