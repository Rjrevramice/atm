            ...
            <div class="card">
                <div class="card-body">
                   <form action="{{ route('admin.plan.update', $plan->id) }}" method="POST">
                     ...
                     <div class="row">
                             <div class="form-group col-lg-3">
                               <label for="Month" class="form-control-label font-weight-bold">@lang('Month')</label>
                             <input type="number" class="form-control form-control-lg" name="month" value="{{__($plan->month)}}"  maxlength="8" required="">
                            </div>

                            <div class="form-group col-lg-3">
                                <label for="Tax" class="form-control-label font-weight-bold">@lang('Tax') - %</label>
                             <input type="text" class="form-control form-control-lg" name="tax" value="{{__($plan->tax)}}"  maxlength="191" required="">
                            </div>
                    </div>
