...
{
    public function provide_helps(){
        $pageTitle = 'Provide Helps';
        $helps = Help::where('help_type','provide_help')->with('user')->orderBy('id','desc')->paginate(getPaginate());
        $emptyMessage = 'No Provide Helps.';
        return view('admin.reports.provide_helps', compact('pageTitle', 'helps', 'emptyMessage'));
    }
    public function get_helps(){
        $pageTitle = 'Get Helps';
        $helps = Help::where('help_type','get_help')->with('user')->orderBy('id','desc')->paginate(getPaginate());
        $emptyMessage = 'No Get Helps.';
        return view('admin.reports.get_helps', compact('pageTitle', 'helps', 'emptyMessage'));
    }
