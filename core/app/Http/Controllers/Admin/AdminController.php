...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $matirxInfo['plan'] = Plan::count(); 
        $matirxInfo['subscription'] = PlanSubscription::count(); 

        $pin = Pin::count(); 
        $commissions = Commissions::sum('amount'); 
        ...
        // helps
        $widget['provide_helps'] = Help::where('help_type','provide_help')->count();
        $widget['get_helps'] = Help::where('help_type','get_help')->count();
        $widget['support'] = SupportTicket::count();
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'report', 'withdrawals', 'chart','payment','paymentWithdraw','depositsMonth','withdrawalMonth','months','deposits', 'matirxInfo', 'pin', 'commissions'));
    }
