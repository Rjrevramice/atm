...
class FrontendController extends Controller
{
    ...
    public function plan_detail(){
        $pageTitle = "Update Plan Detail";
        $frontend = DB::table('frontends')->where('data_keys','plan_detail')->first();
        return view('admin.frontend.frontend', compact('frontend', 'pageTitle'));
    }
