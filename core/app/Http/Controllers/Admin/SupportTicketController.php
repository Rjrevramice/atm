...
class SupportTicketController extends Controller
{
    ...
    //     $messages = SupportMessage::with('attachments')->with('ticket')->with('admin')->where('supportticket_id', $ticket->id)->orderBy('id','desc')->get();
    ...
    public function ticketReply($id)
    {
        ...
        $messages = SupportMessage::with(['attachments', 'ticket', 'admin'])
            ->where('supportticket_id', $ticket->id)
            ->orderBy('id', 'desc')
            ->get();    
